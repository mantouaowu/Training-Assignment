<template>
  <div class="wrapper">
    ...
    <ul class="foodtype">
      ...
      <li>
        <img src="../assets/dcfl01.png" height="120" width="140"/>
        <p>美食</p>
      </li ></router-link>
      <router-link to="/BusinessList">
      <li>
        <img src="../assets/dcfl02.png" height="120" width="140"/>
        <p>早餐</p>
      </li></router-link>
      <router-link to="/BusinessList">
      <li>
        <img src="../assets/dcfl03.png" height="120" width="140"/>
        <p>跑腿代购</p>
      </li></router-link>
      <router-link to="/BusinessList">
      <li>
        <img src="../assets/dcfl04.png" height="120" width="140"/>
        <p>汉堡披萨</p>
      </li></router-link>
      <router-link to="/BusinessList">
      <li>
        <img src="../assets/dcfl05.png" height="120" width="140"/>
        <p>甜品饮食</p>
      </li></router-link>
      <router-link to="/BusinessList">
      <li>
        <img src="../assets/dcfl06.png" height="120" width="140"/>
        <p>速食简餐</p>
      </li></router-link>
      <router-link to="/BusinessList">
      <li>
        <img src="../assets/dcfl07.png" height="120" width="140"/>
        <p>地方小吃</p>
      </li ></router-link>
      <router-link to="/BusinessList">
      <li>
        <img src="../assets/dcfl08.png" height="120" width="140"/>
        <p>米粉面馆</p>
      </li></router-link>
      <router-link to="/BusinessList">
      <li>
        <img src="../assets/dcfl09.png" height="120" width="140"/>
        <p>包子粥铺</p>
      </li></router-link>
      <router-link to="/BusinessList">
      <li>
        <img src="../assets/dcfl10.png" height="120" width="140"/>
        <p>炸鸡炸串</p>
      </li></router-link>
    </ul>
    <!--横幅广告部分 -->
